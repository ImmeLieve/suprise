...
def end_score():
        ...
        st.info('Ja het heeft zeker iets te maken met je cadeau 🎁. Nu je straks veel meer vrije tijd hebt doordat je digitale skills zo erg verbeterd zijn 🖥️👍, is het tijd voor een nieuwe hobby!  \n'
